<template>
  <div class="flex w-[153px] flex-none items-center justify-center gap-4" v-if="winner">
    <div
      id="blue"
      class="selection:bg-blue rounded-md border-2 border-neutral-200 dark:border-neutral-800 bg-neutral-300 dark:bg-neutral-700 selection:text-black dark:selection:text-white"
      :class="{
        'border-red-300! dark:border-red-500!': blueError,
    ...
    <Icon :name="error ? 'times' : 'check'" class="text-neutral-600 dark:text-neutral-400" />

    <div
      id="orange"
      class="selection:bg-orange rounded-md border-2 border-neutral-200 dark:border-neutral-800 bg-neutral-300 dark:bg-neutral-700 selection:text-black dark:selection:text-white"
      :class="{
        'border-red-300! dark:border-red-500!': orangeError,
